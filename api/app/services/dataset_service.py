...
class DatasetService:
    ...
    def extract_text_from_unstructured(self, file_content: bytes, file_extension: str) -> str:
        file_like_object = BytesIO(file_content)
        elements = partition(file=file_like_object, file_extension=file_extension)
        return "\n".join([str(e) for e in elements])

    async def vectorize_and_chunk_document(self, document_id: str, file_content: bytes, file_extension: str):
    ...
    async def vectorize_document(self, dataset_id: str, document_id: str):
        ...
        await self.vectorize_and_chunk_document(document_id, file_content, file_extension)
