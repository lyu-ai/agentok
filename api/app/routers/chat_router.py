...
async def start_chat(message: MessageCreate, chat_id: str, service: ChatService = Depends(get_chat_service)):
...
async def send_human_input(message: MessageCreate, chat_id: str, service: ChatService = Depends(get_chat_service)):
